...
@section('title', "employee Search: '{$query}'")
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex flex-wrap gap-2 align-items-center">
                ...
                <a href="{{ route('employee.search_results', ['query' => $query, 'type' => 'categories']) }}" 
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="{{ route('employee.store.index') }}" class="btn btn-primary">
                    <i class="fas fa-store me-2"></i> Browse Stores
                </a>
                <a href="{{ route('employee.blog.index') }}" class="btn btn-success">
                    <i class="fas fa-blog me-2"></i> Browse Blogs
                </a>
                <a href="{{ route('employee.category.index') }}" class="btn btn-info">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('employee.store.store_details', ['slug' => Str::slug($store->slug)]) }}" 
